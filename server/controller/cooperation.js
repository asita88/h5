module.exports = (app) => ({
  ...
  async addCooperationUser() {
    ...
    let cooperationList = await $service.page.addCooperationUser(
      pageId,
      userIds
    );
  ...
  async getCooperationUserListByPageId() {
    ...
    let cooperationList = await $service.page.getCooperationUserListByPageId(
      pageId
    );
    $helper.returnBody(true, cooperationList);
  },
  ...
  async removeCooperationUser() {
    ...
    const cooperationList = await $service.page.removeCooperationUser(
      pageId,
      userId
    );
    $helper.returnBody(true, cooperationList);
