module.exports = (app) => {
  ...
  router.post(
    "/quark/page/setPublish",
    $middleware.auth,
    $controller.page.publish
  );
  router.post(
    "/quark/page/setTemplate",
    $middleware.auth,
  ...
  // 页面渲染
  router.post("/quark/joinUs/:_id", $controller.page.joinUs);
  ...
  // 我的图片库
  router.get(
    "/quark/imageLib/myImages",
    $middleware.auth,
    $controller.image.getMyImages
  );
  router.post(
    "/quark/imageLib/upload",
    $middleware.auth,
  ...
  // 我的图片库
  router.get(
    "/quark/whatsApp/myWhatsApps",
    $middleware.auth,
    $controller.whatsApp.myWhatsApps
  );
  router.post(
    "/quark/whatsApp/addWhatsApp",
    $middleware.auth,
    $controller.whatsApp.addWhatsApp
  );
  router.post(
    "/quark/whatsApp/delWhatsApp",
    $middleware.auth,
