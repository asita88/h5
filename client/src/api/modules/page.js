 ...
 * */
// 获取我的模板
export const getMyTemplates = (p) =>
  $axios.get("/quark/page/getMyTemplates", p);

/**
 * ========================================================================
 * */
// 获取模板市场模板
export const getPublishTemplates = (p) =>
  $axios.get("/quark/page/getPublishTemplates", p);

/**
 * ========================================================================
 * */
// 获取协作人列表
export const getCooperationUserListByPageId = (p) =>
  $axios.get("/quark/page/getCooperationList", p);
// 按userIds添加协作人
export const addCooperation = (p) =>
  $axios.post("/quark/page/addCooperation", p);
// 删除协作人
export const delCooperation = (p) =>
  $axios.post("/quark/page/delCooperation", p);

// 获取模板市场模板
export const getPageData = (p) => $axios.get("/quark/dashboard/getPageData", p);
